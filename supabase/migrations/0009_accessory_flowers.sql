...
-- ===========================================================================
-- Des fleurs de cerisier grises, dispersées aux coins de la photo
...
insert into public.shop_items (sku, name, description, category, price, payload, requirement, is_default, sort_order) values
  ('accessory_flowers', 'Plantes japonaises', 'Des fleurs de cerisier grises, dispersées autour de ta photo.', 'avatar_accessory', 200, '{"accessory":"flowers"}', '{}', false, 72)
