...
export const GAMES: GameEntry[] = [
  ...
  { id: 'puissance4', name: 'Puissance 4', tagline: 'Quatre alignés, avec des pouvoirs.', players: '2 à 4 joueurs', icon: Grid3x3, to: '/puissance4' },
  { id: 'puissance4-original', name: 'Puissance 4 Original', tagline: 'Le classique, sans pouvoirs.', players: '2 à 4 joueurs', icon: Disc, to: '/puissance4-original' },
];
